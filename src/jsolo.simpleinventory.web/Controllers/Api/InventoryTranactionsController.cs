...
public class InventoryTransactionsController : AuthorizePermissionsBaseController
{
    public InventoryTransactionsController(UserManager<User> userManager, RoleManager<UserRole> roleManager) : base(userManager, roleManager)
    {
    }
