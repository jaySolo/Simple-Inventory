...
public class CurrenciesController : AuthorizePermissionsBaseController
{
    public CurrenciesController(UserManager<User> userManager, RoleManager<UserRole> roleManager) : base(userManager, roleManager)
    {
    }
