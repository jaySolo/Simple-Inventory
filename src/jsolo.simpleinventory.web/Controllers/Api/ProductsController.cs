...
public class ProductsController : AuthorizePermissionsBaseController
{
    public ProductsController(UserManager<User> userManager, RoleManager<UserRole> roleManager) : base(userManager, roleManager)
    {
    }
