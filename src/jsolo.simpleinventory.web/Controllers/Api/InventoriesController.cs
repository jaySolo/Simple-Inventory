...
public class InventoriesController : AuthorizePermissionsBaseController
{
    public InventoriesController(UserManager<User> userManager, RoleManager<UserRole> roleManager) : base(userManager, roleManager)
    {
    }
