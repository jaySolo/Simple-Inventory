...
public class GetRolesQueryHandler : IRequestHandler<GetRolesQuery, List<RoleViewModel>>
{
    ...
    public GetRolesQueryHandler(RoleManager<UserRole> roleManager)
    {
...
public class GetRoleDetailsQueryHandler : IRequestHandler<GetRoleDetailsQuery, RoleViewModel?>
{
    private readonly RoleManager<UserRole> _roleManager;

    public GetRoleDetailsQueryHandler(RoleManager<UserRole> roleManager)
    {
        _roleManager = roleManager;
    }
