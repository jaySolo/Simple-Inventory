...
public class GetUsersQueryHandler : IRequestHandler<GetUsersQuery, List<UserProfileViewModel>>
{
...
public class GetUserDetailsQueryHandler : IRequestHandler<GetUserDetailsQuery, UserProfileViewModel?>
{
    private readonly UserManager<User> _userManager;
