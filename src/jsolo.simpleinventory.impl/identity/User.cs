...
namespace jsolo.simpleinventory.impl.identity
{
    ...
    {
        #region  properties
        public virtual string Surname { get; protected set; } = string.Empty;

        public virtual string FirstName { get; protected set; } = string.Empty;

        public virtual DateTime? Birthdate { get; protected set; }

        public virtual string Position { get; protected set; } = string.Empty;
        ...
        public virtual string CreatorId { get; protected set; } = string.Empty;
        ...
        /// </summary>
        public virtual string LastModifierId { get; protected set; } = string.Empty;
        ...
        public virtual string FileExtension { get; protected set; } = string.Empty;

        public virtual string FileContentType { get; protected set; } = string.Empty;
        ...
        )
        {
            ...
            this.CreatorId = creatorId ?? string.Empty;
            this.LastModifiedOn = updatedOn;
            this.LastModifierId = lastUpdaterId ?? string.Empty;
        }
