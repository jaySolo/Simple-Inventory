...
namespace jsolo.simpleinventory.impl.identity
{
    public class UserRole: IdentityRole<int>, IIdentityPermissionRole<UserPermission, int>
    {
        ...
        public virtual string CreatedBy { get; protected set; } = string.Empty;

        public virtual DateTime CreatedOn { get; protected set; }

        public virtual string LastModifiedBy { get; protected set; } = string.Empty;
        ...
        public UserRole(
            ...
            DateTime? createdOn = null, string? creator = null
        ) {
            ...
            this.CreatedBy = !string.IsNullOrWhiteSpace(creator) ? creator : string.Empty;
        }
        #endregion
