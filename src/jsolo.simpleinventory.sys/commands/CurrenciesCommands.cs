...
{
    public CurrencyViewModel NewCurrency { get; set; }
}



public class CreateCurrencyCommandHandler : RequestHandlerBase<CreateCurrencyCommand, DataOperationResult<CurrencyViewModel>>
{
...
public class DeleteCurrencyCommandHandler : RequestHandlerBase<DeleteCurrencyCommand, DataOperationResult>
{
