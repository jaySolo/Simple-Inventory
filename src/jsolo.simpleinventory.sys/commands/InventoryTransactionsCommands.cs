...
{
    public InventoryTransactionViewModel NewInventoryTransaction { get; set; }
}



public class CreateInventoryTransactionCommandHandler : RequestHandlerBase<CreateInventoryTransactionCommand, DataOperationResult<InventoryTransactionViewModel>>
{
...
public class UpdateInventoryTransactionCommand : IRequest<DataOperationResult<InventoryTransactionViewModel>>
{
    ...
    public InventoryTransactionViewModel UpdatedInventoryTransaction { get; set; }
}


public class UpdateInventoryTransactionCommandHandler : RequestHandlerBase<CreateInventoryTransactionCommand, DataOperationResult<InventoryTransactionViewModel>>
{
...
public class DeleteInventoryTransactionCommandHandler : RequestHandlerBase<DeleteInventoryTransactionCommand, DataOperationResult>
{
