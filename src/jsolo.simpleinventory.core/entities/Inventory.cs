...
#nullable disable
    ...
    /// <returns></returns>
    public virtual Inventory SetProduct(Product product)
    {
        this.Item = product;
    ...
    // /// <param name="location"></param>
    // /// <returns></returns>
    // public virtual Inventory SetLocationAs(Location location)
    // {
    ...
    public virtual Inventory SetStockCountAs(double quantity)
    {
        if (quantity < 0)
        {
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentOutOfRangeException"></exception>
    public virtual Inventory SetMinimumQuantityAs(double quantity)
    {
        if (quantity < 0)
        {
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentOutOfRangeException"></exception>
    public virtual Inventory SetReorderQuantityAs(double quantity)
    {
        if (quantity <= 0)
        {
    ...
    /// <param name="transactions"></param>
    /// <returns></returns>
    public virtual Inventory SetTransactionsAs(
#nullable enable
        IEnumerable<InventoryTransaction>? transactions = null
#nullable disable
    )
